...
/**
 * Created by fikriimaduddin on 10/19/17.
 */

public class AdapterAllNews extends RecyclerView.Adapter<AdapterAllNews.ViewHolder> {

  Activity context;
  List<PojoIsi.IsiBean> list_data;

  public AdapterAllNews(List<IsiBean> isi, FragmentActivity activity) {
  ...
  public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    return new AdapterAllNews.ViewHolder(view);
  }

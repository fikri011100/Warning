    ...
    private void getSearch() {
        StringRequest request = new StringRequest(Method.POST, url, new Response.Listener<String>() {
                ...
                try {
                    if (String.valueOf(new JSONObject(response).getString("msg")).equals("Data Semua Search")){
                        try {
                            ...
                            final AdapterIsiNew adapterPopuler = new AdapterIsiNew(search.getIsi(), SearchActivity.this);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(getApplicationContext(),"Check Your Internet Connection And Refresh",Toast.LENGTH_LONG).show();
            }
        }) {
            @Override

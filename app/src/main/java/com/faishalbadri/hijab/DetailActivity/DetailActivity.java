            ...
            try {
              if (String.valueOf(new JSONObject(response).getString("msg"))
                ...
                try {
                  ...
                  final PojoPerKategori perkat = gsonDetail
                      .fromJson(response, PojoPerKategori.class);
                  final AdapterMoreNewsDetail adapterMoreNewsDetail = new AdapterMoreNewsDetail(
                      perkat.getIsi(), getApplicationContext());

...
public class HomeFragment extends Fragment {
  ...
  private void getHot() {
    StringRequest request = new StringRequest(Request.Method.GET, urlHot,
  ...
  private void getTop() {
    ...
    StringRequest request = new StringRequest(Request.Method.GET, urlTop,
        new Response.Listener<String>() {
          @Override
          public void onResponse(String response) {
            try {
  ...
  private void getNew() {
    ...
    StringRequest request = new StringRequest(Request.Method.GET, urlNew,
        new Response.Listener<String>() {
          @Override
          public void onResponse(String response) {
            try {
  ...
  private void getSlider() {
    ...
    StringRequest request = new StringRequest(Request.Method.GET, urlSlider,
        new Response.Listener<String>() {
          @Override
          public void onResponse(String response) {
            try {
              if (String.valueOf(new JSONObject(response).getString("msg"))
                ...
                try {
                  ...
                  for (int a = 0; a < slider.getSlider().size(); a++) {
                    ...
                    file_maps.put(slider.getSlider().get(a).getSlider_judul(),
                        Server.BASE_IMG + slider.getSlider().get(a).getSlider_gambar());

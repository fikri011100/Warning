package com.faishalbadri.hijab.First.Slider;
...
public class SliderLayout extends RelativeLayout {
  ...
  /**
   * InfiniteViewPager is extended from ViewPagerEx. As the name says, it can scroll without
   * bounder.
   */
  ...
  public SliderLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    final TypedArray attributes = context.getTheme()
        .obtainStyledAttributes(attrs, com.daimajia.slider.library.R.styleable.SliderLayout,
            defStyle, 0);

    mTransformerSpan = attributes
        .getInteger(com.daimajia.slider.library.R.styleable.SliderLayout_pager_animation_span,
            1100);
    mTransformerId = attributes
        .getInt(com.daimajia.slider.library.R.styleable.SliderLayout_pager_animation,
            Transformer.Default.ordinal());
    mAutoCycle = attributes
        .getBoolean(com.daimajia.slider.library.R.styleable.SliderLayout_auto_cycle, true);
    ...
    mViewPager = (InfiniteViewPager) findViewById(
        com.daimajia.slider.library.R.id.daimajia_slider_viewpager);
  ...
  public void addOnPageChangeListener(FragmentActivity awal) {
  ...
  /**
   * Inject your custom animation into PageTransformer, you can know more details in {@link
   * BaseAnimationInterface}, and you can see a example in {@link com.daimajia.slider.library.Animations.DescriptionAnimation}
   */
  ...
  public enum PresetIndicators {
    Center_Bottom("Center_Bottom",
        com.daimajia.slider.library.R.id.default_center_bottom_indicator),
